...
form1.addEventListener("input", (e) => console.log(e.target.value));
...
form1.addEventListener("select", () => console.log("inp1:选中了文本"));
...
form1.addEventListener("change", (e) => console.log("changed to " + e.target.value));
